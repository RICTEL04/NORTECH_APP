...
@Composable
fun BottomNavigationBarEstudiante(navController: NavController, indexes: Int) {
    Surface(
        color = Color.White,
        ...
        Row(
            ...
            BottomNavigationItem(
                ...
                label = "Casos",
                selected = indexes == 1,
                onClick = { navController.navigate("CasosEstudiantes") }
            )
            BottomNavigationItem(
                icon = R.drawable.citas,
                label = "Agenda",
                selected = indexes == 2,
                onClick = { navController.navigate("AgendaEstudiante") }
            )
            BottomNavigationItem(
            ...
            BottomNavigationItem(
                ...
                selected = indexes == 4,
                onClick = {
                    navController.navigate("PerfilEstudiantes") }
            )
        }
    }
}
