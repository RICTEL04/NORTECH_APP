...
@Composable
fun MainView(viewModel: UserViewModel, navController: NavController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(horizontal = 16.dp, vertical = 8.dp), // Ajuste del margen superior e inferior
                ...
                Spacer(modifier = Modifier.weight(1f)) // Empuja el botón hacia el borde derecho

                Button(
                    onClick = { navController.navigate("NoticiaForm") },
                    colors = ButtonDefaults.buttonColors(Color(0xFF1E88E5)),
                    modifier = Modifier.height(40.dp) // Ajusta la altura del botón para que no sea demasiado grande
                ) {
                    Icon(
                    ...
                    Text(text = "New Noticia", color = Color.White)
                }
            }
