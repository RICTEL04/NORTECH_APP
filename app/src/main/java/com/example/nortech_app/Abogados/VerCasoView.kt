    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                actions = {
                    IconButton(onClick = { navController.navigate("UPFormCaso") }) {
                        Icon(
                            imageVector = Icons.Default.Create, // Puedes cambiar el ícono aquí
        ...
        Surface(
            ...
            Column(
                ...
                Row(
                    ...
                    Button(
                        onClick = {
                            launcher.launch("*/*") // Selección de cualquier tipo de archivo
                        },
